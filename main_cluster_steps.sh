...
#module load lang/R/3.4.0-foss-2017a-X11-20170314-bare #new OS
...
CDHIT_OUT=validSequences.unmapped.100.clustered.14.seqIO
...
Rscript clusteringToSeqOI.unmapped.R
Rscript clusteringToSeqOI.byMapping.R
