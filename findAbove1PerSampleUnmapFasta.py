...
# script to filter sam files for reads that have a minimum number of reads
# Anna Heintz-Buschart, August 2017
...
parser.add_argument('-o','--outputFile', default="gt1psUnmappedSequences.fa",type=str,help='name of output fasta file')
